include device/msft/cityman/BoardConfigCommon.mk

# Board Information
TARGET_BOOTLOADER_BOARD_NAME := cityman
TARGET_BOARD_PLATFORM := cityman
...
BOARD_KERNEL_CMDLINE     += androidboot.hardware=cityman androidboot.boot_devices=soc/f98a4900.sdhci
